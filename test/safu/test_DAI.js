...
describe("Citadel - DAI", async () => {
    ...
    it("Should work", async () => {
        ...
        await vault.connect(user1).withdraw(await vault.balanceOf(user1.address), DAI.address, [0,0,0,0])
        await vault.connect(user2).withdraw(await vault.balanceOf(user2.address), DAI.address, [0,0,0,0])
        await vault.connect(user3).withdraw(await vault.balanceOf(user3.address), DAI.address, [0,0,0,0])
