...
describe("DAO Avalanche", function () {
    it("Should work on DeXToken-Stablecoin strategy", async function () {
        ...
        const deXStableStrategyProxyAddr = "0xB309805d4dE558042b537D7Cc35e06ae5601E3af"
        ...
        const avaxStableVaultProxyAddr = "0x6fD8c0c6caFB7B99c47BbE332cAE42b32017CD58"
        ...
        await joeRouter.swapExactAVAXForTokens(
            0, [WAVAXAddr, JOEAddr], JOEUSDCVaultAddr, Math.ceil(Date.now() / 1000) + 10000,
        ...
        // console.log(ethers.utils.formatEther(await avaxStableVault.getAllPoolInUSD())) // 49592.611800790402852058
        ...
        const deXStableVaultAddr = avaxStableVault.address
        const deXStableStrategyAddr = deXStableStrategy.address
        ...
        const getAmountsOutMinDeXStable = async (shareToWithdraw, stablecoinAddr, provider) => {
            ...
            const dexStableStrategy = new ethers.Contract(deXStableStrategyAddr, deXAvaxStrategyABI, provider)
        ...
        amountsOutMin = await getAmountsOutMinDeXStable((await avaxStableVault.balanceOf(client.address)).div(3), USDTAddr, deployer)
        ...
        amountsOutMin = await getAmountsOutMinDeXStable(await avaxStableVault.balanceOf(client2.address), USDTAddr, deployer)
        await avaxStableVault.connect(client2).withdraw(avaxStableVault.balanceOf(client2.address), USDTAddr, amountsOutMin)
        amountsOutMin = await getAmountsOutMinDeXStable(await avaxStableVault.balanceOf(client3.address), USDTAddr, deployer)
        ...
        // amountsOutMin = await getAmountsOutMinDeXStable((await avaxStableVault.balanceOf(client.address)).div(3), USDCAddr, deployer)
        ...
        // amountsOutMin = await getAmountsOutMinDeXStable(await avaxStableVault.balanceOf(client2.address), USDCAddr, deployer)
        // await avaxStableVault.connect(client2).withdraw(avaxStableVault.balanceOf(client2.address), USDCAddr, amountsOutMin)
        // amountsOutMin = await getAmountsOutMinDeXStable(await avaxStableVault.balanceOf(client3.address), USDCAddr, deployer)
        ...
        // amountsOutMin = await getAmountsOutMinDeXStable((await avaxStableVault.balanceOf(client.address)).div(3), DAIAddr, deployer)
        // await avaxStableVault.connect(client).withdraw((await avaxStableVault.balanceOf(client.address)).div(3), DAIAddr, amountsOutMin)
        // amountsOutMin = await getAmountsOutMinDeXStable(await avaxStableVault.balanceOf(client2.address), DAIAddr, deployer)
        // await avaxStableVault.connect(client2).withdraw(avaxStableVault.balanceOf(client2.address), DAIAddr, amountsOutMin)
        // amountsOutMin = await getAmountsOutMinDeXStable(await avaxStableVault.balanceOf(client3.address), DAIAddr, deployer)
